...
void FinishClientPutInServer( CTDPPlayer *pPlayer )
{
	if (!pPlayer->IsBot())
	{
...
void ClientPutInServer( edict_t *pEdict, const char *playername )
{
	...
	CTDPPlayer *pPlayer = CTDPPlayer::CreatePlayer( "player", pEdict );
...
void ClientActive( edict_t *pEdict, bool bLoadGame )
{
	...
	CTDPPlayer *pPlayer = ToTDPPlayer( CBaseEntity::Instance( pEdict ) );
...
{
	CreateGameRulesObject( "CTDPGameRules" );
}
