...
//
// $Workfile:     $
// $Date: 2005/01/27 17:39:10 $
//
//-----------------------------------------------------------------------------
// $Log: tdp_bot_temp.cpp,v $
// Revision 1.1  2005/01/27 17:39:10  godg2002
// *** empty log message ***
//
//
// $NoKeywords: $
...
class CTDPBot : public CTDPPlayer
{
public:
	bool			m_bBackwards;
...
LINK_ENTITY_TO_CLASS( tdp_bot, CTDPBot );
...
public:
	static CBasePlayer* ClientPutInServerOverride_Bot( edict_t *pEdict, const char *playername )
	{
		...
		CTDPBot *pPlayer = static_cast<CTDPBot *>( CreateEntityByName( "tdp_bot" ) );
		if ( pPlayer )
		{
...
CBasePlayer *BotPutInServer( bool bFrozen )
{
	...
	// This trick lets us create a CTDPBot for this client instead of the CTDPPlayer
	...
	CTDPBot *pPlayer = ((CTDPBot*)CBaseEntity::Instance( pEdict ));
...
void Bot_RunAll( void )
{
	...
	{
		CTDPPlayer *pPlayer = ToTDPPlayer( UTIL_PlayerByIndex( i ) );

		if ( pPlayer && (pPlayer->GetFlags() & FL_FAKECLIENT) )
		{
			CTDPBot *pBot = dynamic_cast< CTDPBot* >( pPlayer );
			if ( pBot )
				Bot_Think( pBot );
		}
	}
...
// Output : 	virtual void
//-----------------------------------------------------------------------------
static void RunPlayerMove( CTDPPlayer *fakeclient, CUserCmd &cmd, float frametime )
{
	if ( !fakeclient )
		return;
...
void Bot_UpdateStrafing( CTDPBot *pBot, CUserCmd &cmd )
{
...
void Bot_UpdateDirection( CTDPBot *pBot )
{
...
void Bot_FlipOut( CTDPBot *pBot, CUserCmd &cmd )
{
...
void Bot_HandleSendCmd( CTDPBot *pBot )
{
...
void Bot_ForceFireWeapon( CTDPBot *pBot, CUserCmd &cmd )
{
...
void Bot_SetForwardMovement( CTDPBot *pBot, CUserCmd &cmd )
{
...
void Bot_HandleRespawn( CTDPBot *pBot, CUserCmd &cmd )
{
