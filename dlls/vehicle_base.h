...
public:
	...
	virtual void		EnterVehicle( CBasePlayer *pPlayer, int iRole ) { EnterVehicle(pPlayer); };
...
protected:
	...
	CNetworkHandle( CBasePlayer, m_hPlayer );		//Peho: driver
	CNetworkHandle( CBasePlayer, m_hPassenger );	//Peho: passenger (obvious)
public:
