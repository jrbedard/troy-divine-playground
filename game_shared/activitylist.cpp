...
//===========================
	REGISTER_SHARED_ACTIVITY( ACT_VM_THIRDATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_VM_BLOCK );
	REGISTER_SHARED_ACTIVITY( ACT_VM_UNBLOCK );
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY ( ACT_GET_DOWN );
	REGISTER_SHARED_ACTIVITY ( ACT_GET_UP );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_STAND_AIM_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_CROUCH_AIM_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_CROUCHWALK_AIM_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_WALK_AIM_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_RUN_AIM_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_PRONE_AIM_GREN );
	...
	// ZOom
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_STAND_ZOOM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_CROUCH_ZOOM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_CROUCHWALK_ZOOM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_WALK_ZOOM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_RUN_ZOOM_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_PRONE_ZOOM_TOMMY );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_PRIMARYATTACK_DEPLOYED_TOMMY );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_PRIMARYATTACK_PRONE_DEPLOYED_TOMMY );
	...
	// Grenades
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_PRIMARYATTACK_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_SECONDARYATTACK_GREN );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_PRIMARYATTACK_PRONE_GREN );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_RELOAD_THOMPSON );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_RELOAD_DEPLOYED_MG42 );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_RELOAD_PRONE_THOMPSON );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_RELOAD_PRONE_DEPLOYED_MG42 );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_RELOAD_PRONE_DEPLOYED_MG34 );

	// Prone zoomed aim
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_PRONE_ZOOM_FORWARD_TOMMY );
	...
	// Hand Signals
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_STICKTOGETHER );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_FALLBACK );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_NO );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_YES );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_SNIPER );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_BACKUP );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_ENEMYRIGHT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_ENEMYLEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_GRENADE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_FLANKLEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_MOVEOUT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_FLANKRIGHT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_AREACLEAR );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_COVERINGFIRE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_TAKECOVER );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_HOLDPOS );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_SPREADOUT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_ENEMYSPOTTED );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_DISPLACE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PREPARE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_GOGOGO );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_ENEMYAHEAD );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_ENEMYBEHIND );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_MGAHEAD );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_MOVEUPMG );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_CEASEFIRE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_USEGRENS );

	// Prone Hand Signals
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_MOVEOUT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_FLANKLEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_FLANKRIGHT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_BACKUP );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_AREACLEAR );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_FALLBACK );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_SNIPER );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_YES );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_NO );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_ENEMYLEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_ENEMYRIGHT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_GRENADE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_COVERINGFIRE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_HOLDPOS );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_SPREADOUT );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_STICKTOGETHER );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_TAKECOVER );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_ENEMYSPOTTED );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_DISPLACE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_PREPARE );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_GOGOGO );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_ENEMYAHEAD );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_ENEMYBEHIND );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_MGAHEAD );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_MOVEUPMG );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_USEGRENS );
	REGISTER_SHARED_ACTIVITY ( ACT_DOD_HS_PRONE_CEASEFIRE );
