...
#ifdef CSTRIKE_DLL
	#define TICK_INTERVAL			0.03					// 30 msec ticks (see const.h)
#else
	#define TICK_INTERVAL			DEFAULT_TICK_INTERVAL  // 15 msec ticks (see const.h)
#endif	
...
//#define TEAM_TROYANS			2	// troyan team
//#define TEAM_GREEKS				3	// greek team 

enum eteams_list  // TODO FRED MOVE THIS DOWN...
{
...
{
	VEHICLE_DRIVER = 0,		// There can be only one //Peho: why the 0 ??
