...
BEGIN_PREDICTION_DATA( CTDPPlayer )
...
CTDPWeaponBase* CTDPPlayer::TDPAnim_GetActiveWeapon()
{
	return GetActiveTDPWeapon();
}

bool CTDPPlayer::TDPAnim_CanMove()
{
	return true;
}

void CTDPPlayer::FireBullet( 
