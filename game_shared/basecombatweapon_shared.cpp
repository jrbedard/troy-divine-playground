...
void CBaseCombatWeapon::ItemPostFrame( void )
{
	...
	//TDP_TODO check the code for IN_ATTACK3 for the weapon that would required
	//the ItemPostFrame function of BaseCombatWeapon.
...
//=========================================================
Activity CBaseCombatWeapon::GetThirdAttackActivity( void )
{
	return ACT_VM_THIRDATTACK;
}
...
{
	//TDP_TODO si on a un problème de reload avec le IN_ATTACK3 la cé ici
	if ( m_bReloadsSingly )
	{
		CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
		if ( !pOwner )
