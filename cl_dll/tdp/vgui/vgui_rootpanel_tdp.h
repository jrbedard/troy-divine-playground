...
#ifndef VGUI_ROOTPANEL_TDP_H
#define VGUI_ROOTPANEL_TDP_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class C_TDPRootPanel : public vgui::Panel
{
	typedef vgui::Panel BaseClass;
public:
						C_TDPRootPanel( vgui::VPANEL parent );
	virtual				~C_TDPRootPanel( void );
