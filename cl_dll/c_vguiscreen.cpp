...
void C_VGuiScreen::ClientThink( void )
{
	...
	//TDP_TODO ... heu ... p-e essayer de comprendre un moment donnée
	...
	if (m_nButtonPressed & IN_ATTACK3)
	{
		g_InputInternal->InternalMousePressed(vgui::MOUSE_MIDDLE);
	}
	...
	if (m_nButtonReleased & IN_ATTACK3)
	{
		g_InputInternal->InternalMouseReleased(vgui::MOUSE_MIDDLE);
	}
